      ...
      <div className="container relative mx-auto px-4 sm:px-6 lg:px-8 max-w-7xl">
        ...
        >
          <GridItem
            ...
            description="Perfect type scales, hierarchies, and line-heights. Professional typography that guides attention and improves readability."
          />
          ...
          <GridItem
            ...
            title="Color System"
            description="HSL/OKLCH palettes with semantic variables. Neutral scales, text hierarchies, and brand colors that work in both light and dark modes."
          />
          ...
          <GridItem
            ...
            title="Depth & Shadows"
            description="Dual-shadow elevation system creates realistic depth. Layered shadows, gradients, and highlights make interfaces feel tactile and responsive."
          />
          ...
          <GridItem
            ...
            description="Systematic spacing scales and responsive layouts. Consistent rhythm with proper padding, margins, and grid systems."
          />
          ...
          <GridItem
            ...
            title="Theme Engine"
            description="Seamless light/dark mode switching with automatic color flipping, theme-aware variables, and intelligent contrast adjustments."
          />
          ...
          <GridItem
            ...
            description="WCAG AA compliance with automatic contrast checking, semantic HTML, and keyboard navigation support."
          />
        </motion.ul>
      </div>
    </section>
