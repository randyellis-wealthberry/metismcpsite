    ...
    >
      ...
      <div className="container relative mx-auto px-4 sm:px-6 lg:px-8 max-w-7xl">
        ...
        >
          ...
          >
            Six Powerful Design Tools
          </h2>
          <p className="body-large mx-auto max-w-2xl">
            Professional design systems at your fingertips. Each tool transforms a
            specific aspect of your UI, working together to create cohesive, accessible interfaces.
          </p>
        </motion.div>
